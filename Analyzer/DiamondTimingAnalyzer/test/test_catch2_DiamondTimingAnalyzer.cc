...
static constexpr auto s_tag = "[DiamondTimingAnalyzer]";

TEST_CASE("Standard checks of DiamondTimingAnalyzer", s_tag) {
  const std::string baseConfig{
      R"_(from FWCore.TestProcessor.TestProcess import *
process = TestProcess()
process.toTest = cms.EDProducer("DiamondTimingAnalyzer"
